...
export const metadata = {
  title: 'Experience | Bhavya Sharma - Full Stack Developer',
  description:
    'Explore the professional experience of Bhavya Sharma, a Full Stack Developer working with modern web technologies, AI-powered applications, SaaS products, and production software.',
  ...
  openGraph: {
    ...
    title: 'Experience | Bhavya Sharma - Full Stack Developer',
    description:
      'Explore the professional experience, software development work, and technical contributions of Bhavya Sharma.',
  ...
  twitter: {
    ...
    title: 'Experience | Bhavya Sharma - Full Stack Developer',
    description:
      'Explore the professional experience and software development work of Bhavya Sharma.',
  },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        <header className="space-y-3">
          ...
          <p className="text-base text-neutral-400 leading-relaxed">
            Hands-on software development across production startups and
            independent client deliverables.
          </p>
        </header>

        {/* Experience Timeline */}
        <section
          aria-labelledby="experience-timeline"
          className="space-y-8"
        >
          <h2
          ...
          {EXPERIENCES.map((exp) => (
            ...
            >
              {/* Role & Company */}
              <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-neutral-800">
                <div>
